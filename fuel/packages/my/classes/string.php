...
class String
{
    public static function remove_vietnamese($str) 
    {
    ...
    public static function clean_url($data) 
    {
        // Remove vietnamese
        $data = self::remove_vietnamese($data);
        // Special characters
        $char = explode(" ", "&nbsp; &amp; &#092; &quot; & ! @ # $ % ^ & * ( ) _ + = ? < > , .");
    ...
    public static function my_substr( $string, $from = 0, $to = 40, $type = 0 )
    {
